...
const ECLIPSE_TARGET_POSITION = new THREE.Vector3(0, 0, 0);
const HOVER_SCALE = 1.5;
const LERP_SPEED = 0.05; // Used for both position and scale lerping
const SCATTER_INITIAL_POSITION = new THREE.Vector3(0, 0, 0);
const SPRITE_POSITION_OFFSET = new THREE.Vector3(0, 1.5, 0);
const FLOAT_LERP_SPEED = 0.02; // Adjust this value as needed
...
function updateEclipseBehavior() {
  spheres.forEach((sphere) => {
    sphere.position.lerp(ECLIPSE_TARGET_POSITION, LERP_SPEED);
  });
}
